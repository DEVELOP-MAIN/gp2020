...
$lst = new listado();
$distris = $lst->getSociosMillas('repositor', intval($mes), intval($anio));
$distris_total = $lst->getSociosMillas('repositor', '', intval($anio));
	...
	<body>
		...
		<script>
			...
			function reloadMes(mes) {
				document.location = 'ranking_repositor.php?m='+mes
			}
		</script>
	</body>
</html>
