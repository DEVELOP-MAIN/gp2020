...
$lst = new listado();
	...
	$vendedores = $lst->getSociosMillas('vendedor', intval($mes), intval($anio));
	$vendedores_total = $lst->getSociosMillas('vendedor', '', intval($anio));
	...
	<body>
		...
		<main role="main">
			...
			<section class="gp-performance-equipos">
				<img src="img/equipos_directa-01.svg" alt="Equipos de Venta Directa"/>
			</section>
		...
		<script>
			...
			function reloadMes(mes) {
				document.location = 'ranking_directa.php?m='+mes
			}
