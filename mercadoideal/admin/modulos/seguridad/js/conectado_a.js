	...
	if(parseInt(result))
	{
		...
		admin = "<div id='nav'>";
          ...
          admin += "<ul>";
          	...
          	admin += "<li><a href='../noticias/' class='extizq'>Noticias</a></li>";
           	admin += "<li><a href='../campanias/' class='extizq'>Categorias de premios</a></li>";
          	admin += "<li><a href='../premios/' class='extizq'>Premios</a></li>";
          	admin += "<li><a href='../puntos/' class='extizq'>Puntos</a></li>";
						admin += "<li><a href='../seguimiento/' class='extizq'>Seguimiento</a></li>";
          	admin += "<li><a href='../grupos/' class='extizq'>Grupos de Supermercados</a></li>";
          	admin += "<li><a href='../clientes/' class='extizq'>Supermercados</a></li>";          	
          admin += "</ul>";
				admin += "</li>";
			admin += "</ul>";
