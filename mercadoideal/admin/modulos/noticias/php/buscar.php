...
//traigo el listado de noticias existentes
$ls = new listado($pag,$cant);
$listado = $ls->getNoticias($_GET['b'],$_GET['t']);
$nro = count($listado);
if($nro==0) 
{
?>
...
<table id="table-1" cellspacing="0" width="100%">
	...
	<tbody>
		...
		<tr>			
			...
			<?php
			if($listado[$i]['tipo']=="N") echo "Noticia"; else echo "Tip";
			?></td>
			...
			<td valign="top" class="<?php echo $class;?>" align="center">
				<a href='#' onclick="showEditForm('<?php echo $listado[$i]['idnoticia'];?>');">
					<img src="../../img/btn_editar.png" alt="Editar noticia" title="Editar noticia" width="31" height="31" border="0" />
				</a>
			</td>			
			<td valign="top" class="<?php echo $class;?>" align="center">
				<a href='#' onclick="showDeleteForm('<?php echo $listado[$i]['idnoticia'];?>');">
					<img src="../../img/btn_eliminar.png" alt="Eliminar noticia" title="Eliminar noticia" width="31" height="31" border="0" />
				</a>
			</td>			
		</tr>
		<?php
