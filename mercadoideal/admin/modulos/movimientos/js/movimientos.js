...
function showAddForm() {
	...
	$('textoayuda').innerHTML = "Ingrese los datos del nuevo movimiento.<BR><BR>El campo <strong>puntos</strong> es obligatorio.<BR><BR>Los puntos pueden tener signo <strong>-</strong> si se trata de un movimiento negativo.<BR><BR>&#160;";
	$('btneditar').hide();	
	$('btnagregar').show();
}
...
function showEditForm(idingreso) {	
	...
	$('textoayuda').innerHTML = "Aqu&#237; puede modificar los datos del movimiento.<BR><BR>El campo <strong>puntos</strong> es obligatorio.<BR><BR>Los puntos pueden tener signo <strong>-</strong> si se trata de un movimiento negativo.<BR><BR>&#160;";
...
//busca los datos del movimiento manual elegido en la DB
...
function vuelveDeEdicion(resultado) {
	...
	if(resultado == '2')
		alert('Faltan datos en el env\u00edo');
	if(resultado == '3')
		alert('Ha habido un error ya que no se encuentra el movimiento que desea modificar');	
	if(resultado == '0')
