...
function poneDatos(requester){
	...
	if(xml_premios.getElementsByTagName('sucursales')[0].childNodes.length > 0)
		sucursales = xml_premios.getElementsByTagName('sucursales')[0].childNodes[0].nodeValue;		
	if(xml_premios.getElementsByTagName('millas')[0].childNodes.length > 0)
		millas = xml_premios.getElementsByTagName('millas')[0].childNodes[0].nodeValue;		
	...
	if(sucursales!='')		$('frm_alta_sucursales').value			= sucursales;
	if(millas!='')				$('frm_alta_millas').value 					= millas;	
