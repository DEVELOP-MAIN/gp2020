...
$ls = new listado();
$listado_clientes = $ls->getClientesSinPaginar($_GET['b'],'1',$_GET['rg'],$ej,$jf,$gr);
...
if($fin>0){
	...
	<html>
		<head>
			...
			<title>USUARIOS DISTRIBUIDORES</title>
			<meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		</head>
		<body>
			<table border="1" cellspacing="2" cellpadding="2">
				<tr>
					<td colspan="16" align="center"><font face="arial" size="2"><strong>LISTADO DE USUARIOS DISTRIBUIDORES</strong></td>
				</tr>';
	$data .= '<TR>';
	...
	for($i=0;$i<$fin;$i++){
		...
		$data =  '<TR>';
			...
			$data .=  '<TD valign="top">DISTRIBUIDORES</TD>';
	...
	<html>
		...
		<body>
			<table border="1" cellspacing="2" cellpadding="2">';	
	$data .=  '<tr>';
	$data .=  '	<td bgcolor="#CCCCCC"><strong>NO HAY USUARIOS DISTRIBUIDORES REGISTRADOS</td>';
	$data .=  '</tr>';
	$data .=  '
			</table>
		</body>
