...
if(!isset($_GET['d'])||!isset($_GET['h'])) {echoErrorXML(65, 'Faltan parametros para este modulo');exit;}

//traigo el listado de puntos asignados a los supermercados adheridos
$ls = new listado($pag,$cant);
$listado = $ls->getPuntosAsignados($_GET['d'],$_GET['h']);
$fin = count($listado);
if($fin == 0){
?>
...
<table id="table-1" cellspacing="0" width="100%">
	...
	<thead>
		<tr bgcolor="#0082A7"> 
			...
			<td bgcolor="#c5c5c5" class="textoBlanco12">Socio</td>
			<td bgcolor="#c5c5c5" class="textoBlanco12">Millas</td>
