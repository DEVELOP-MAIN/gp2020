...
function buscar() {	
  ...
  if(valid.validate()) {			
		...
		t 	= '';
		ts	= "'fisico','giftcard virtual y sucursales','giftcard solo sucursales'";
		var pars = '?cant='+cantidad+'&pag='+pagina+'&b='+b+'&e='+e+'&d='+d+'&h='+h+'&t='+t+'&ts='+ts;
...
function guardarCodigo(idcanje) {
	codseguimiento = $F('codigo_'+idcanje);
	$('img_'+idcanje).src = '../../waiting.gif';
	var pars = '?id='+idcanje+'&cod='+codseguimiento;
	var url = serverRoot+'php/guardar_codigo.php';
	var myAjax = new Ajax.Request(
	url, 
	{
		method: 'get', 
