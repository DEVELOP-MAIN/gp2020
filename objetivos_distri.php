...
$lst = new listado();
if($_SESSION['st'] == 'r') {
	$vendedores = $lst->getObjetivosSocios(intval($mes),intval($anio),'','', 'repositor','so.apellido ASC');
	$vendedores_reg = $lst->getObjetivosSocios(intval($mes),intval($anio),'','', 'repositor','pu.linea ASC');
	$vendedores_lin = $lst->getObjetivosSocios(intval($mes),intval($anio),'','', 'repositor','so.apellido, pu.linea ASC');
} else {
			...
			<section class="gp-performance-tt">
				<div class="container">
					...
					<div class="div_performance">
                                                <span class="active">Performance Ventas</span> | <span class="" onclick="location.href='objetivos_repositor.php'">Performance Ejecución</span>
                                        </div>
							...
							<table class="table table-sm">
								<thead class="thead-light">
									<tr>
										...
										<th width="28%">Distribuidor</th>
										<th width="12%" style="text-align:center">Objetivo</th>
										<th width="12%" style="text-align:center">Cumplimiento</th>
							...
							<table class="table table-sm">
								<thead class="thead-light">
									<tr>
										...
										<th width="15%" style="text-align:center">Cumplimiento</th>
							...
							<table class="table table-sm">
								<thead class="thead-light">
									<tr>
										...
										<th width="10%" style="text-align:center">Cumplimiento</th>
